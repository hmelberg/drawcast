...
const elementSchema = {
  ...
  properties: {
    ...
    look: {
      type: "string",
      enum: ["halftone", "poster", "line"],
      description: "portrait: halftone = newspaper-print dots (the default — keeps faces recognizable); poster = posterized solid regions; line = pen-sketch edges (suits line art and engravings).",
    },
    style: styleSchema,
    draw: drawSchema,
  },
