...
- **Hand over one surprise.** Beyond the insight, give the viewer one TRUE, retellable fact they didn't expect — the kind repeated at dinner ("a neuron can be a metre long", "before birth everyone has a hole in the heart", "the top C vibrates exactly twice as fast"). Plant it where it lands hardest, usually beside the reveal. The truth guard applies with full force: only well-established facts, never invented, never exaggerated — a figure with no honest surprise available simply goes without.
