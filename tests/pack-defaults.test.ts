...
describe("the default catalog", () => {
  ...
  //
  // Re-measured 2026-09-08, merging the space round 2 into the template-on-
  // demand round: 85 ready templates, 287784 chars, mean entry 3363. The
  // ranking barely moved — line_chart is still the largest at 12395, and the
  // round's own sky_map came in third at 9016, under the bound without
  // touching it. Both numbers here are doing work at this size: the ceiling
  // sits ~29% above the largest entry, and the floor ~30% below the total.
